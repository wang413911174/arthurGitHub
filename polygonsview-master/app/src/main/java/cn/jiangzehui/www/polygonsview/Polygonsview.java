...
public class Polygonsview extends View {
    ...
    private void PaintFout(Canvas canvas) {
        ...
        canvas.drawText(str[4], (float) (center - Math.sin(Math.toRadians(360 / 7 / 2)) * one_radius - str_rect.height() / 2 - str_rect.width() ), (float) ((Math.cos(Math.toRadians(360 / 7 / 2)) * one_radius) + center + str_rect.height()), str_paint);
